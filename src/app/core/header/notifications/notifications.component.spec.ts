...
describe('NotificationsComponent', () => {
  ...
  const txArray: any = [
    {
      'hash': '0xf9e3dcdad1cc3c54a8d3c1e7d994d212afd2669b8cf70d2cdc06b1aedfe318cb',
      'to': '0xbee217bfe06c6faaa2d5f2e06ebb84c5fb70d9bf',
      'confirmed': false,
      'type': 'withdraw',
      'data': ['0xbee217bfe06c6faaa2d5f2e06ebb84c5fb70d9bf'],
      'timestamp': 1562960212215
    }, {
      'hash': '0x955c8e72473554d945b7c65dce53bed631f945a61d124d4b921be7d31dd4d16d',
      ...
      'hash': '0x9445fa7aba5d4f4def6fc2b6c70b760e5982970e35358b4a1a48c3cab6249007',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      ...
      'hash': '0xe18947d877479bfdae121d160ef2bd67bb970295c86992f4982d1bd660680759',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      'data': ['0x212c362e33abf6e3e6354363e0634aa1300c3045a18c8c5a08f3bb2a17184768'],
      ...
      'hash': '0x22009d5d9e33f35008d6dffdaf24cd90dc276ee39af7c014f71c36809666ebf6',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      'data': ['0x212c362e33abf6e3e6354363e0634aa1300c3045a18c8c5a08f3bb2a17184768'],
      ...
      'hash': '0xa35adff04d540d2ed58869547b8a82321962268be2fa007425bd40280cdaa180',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'pay',
      'data': {
      ...
      'hash': '0x1c44fa3169ce7e53dfadd7266b77a293557414ec05f27fa72a070ec85fef8c44',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      'data': [
      ...
      'hash': '0x1d0a68797d82a9c4af9f13b1340e8c8b85776f0383c63a1599934cd9accec504',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'pay',
      'data': {
      ...
      'hash': '0xcf5c1d9d5af57cebbf256eeb30473e23275592561185c42ae89079f4395262a5',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      'data': ['0x212c362e33abf6e3e6354363e0634aa1300c3045a18c8c5a08f3bb2a17184768'],
      ...
      'hash': '0x83bcbd6fc3a6dd7413788c496ea738ad53becc45d0f51c4a1813aa2faf86707d',
      'to': '0x50c544d5d44d603695ed221421b8cb5a78681f15',
      'confirmed': true,
      'type': 'withdraw',
      'data': ['0x212c362e33abf6e3e6354363e0634aa1300c3045a18c8c5a08f3bb2a17184768'],
      ...
      'hash': '0x36b3cd4cae26afb849b764a70e621571635582675decff8d5acce0d65ae2f3c4',
  ...
  it('should make tx as finished', () => {
    ...
    mockTxIndex = thisComponent.oNotifications.findIndex(i => i.hashTx === mockTx.hash);
  ...
  it('should render the latest elements', () => {
    ...
    const unconfirmedTx = component.oNotifications.filter(tx => !tx.confirmedTx);
